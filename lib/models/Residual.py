...
class CoevoBlock(nn.Module):
    ...
    def forward(self, joint, vertx, img_feat):
        #print("\n[CoevoBlock]")
        #print("  joint in:", joint.shape)
        #print("  vertx in:", vertx.shape)
        ...
        #print("  img_feat reshaped:", img_feat.shape)
        ...
        #print("  joint_out_feat:", joint_out_feat.shape)
        #print("  vertx_out_feat:", vertx_out_feat.shape)
...
class Residual(nn.Module):
    ...
    def forward(self, joint, img_feat):
        ...
        # #print("joint_feat:", joint.shape)
        # #print("vertx_feat:", vertxs.shape)
        ...
        # #print("\n[Upsample]")
        # #print("  vertxs before upsample:", vertxs.shape)
        vertxs1 = self.upsample_conv1(vertxs)
        #print("  vertxs1:", vertxs1.shape)
