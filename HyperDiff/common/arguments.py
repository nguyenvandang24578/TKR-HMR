...
def parse_args():
    ...
    parser.add_argument('-lr', '--learning-rate', default=0.00007, type=float, metavar='LR', help='initial learning rate')
    parser.add_argument('-lrd', '--lr-decay', default=0.993, type=float, metavar='LR', help='learning rate decay per epoch')
    
    parser.add_argument('-dep', default=16, type=int, help='n_layers') 
    parser.add_argument('-dim_feat', default=256, type=int, help='dim_feat')
    parser.add_argument('-dim_rep', default=512, type=int, help='dim_rep')
    parser.add_argument('-dim_out', default=3, type=int, help='dim_out')
    parser.add_argument('-mlp_ratio', default=4, type=int, help='mlp_ratio')
    parser.add_argument('-attn_drop', default=0.0, type=float, help='attn_drop')
    parser.add_argument('-drop', default=0.0, type=float, help='drop')
    parser.add_argument('-drop_path', default=0.0, type=float, help='drop_path')
    parser.add_argument('-use_layer_scale', action='store_true', default=True, help='use_layer_scale')
    parser.add_argument('-layer_scale_init_value', default=0.00001, type=float, help='layer_scale_init_value')
    parser.add_argument('-use_adaptive_fusion', action='store_true', default=True, help='use_adaptive_fusion')
    parser.add_argument('-hierarchical', action='store_true', default=False, help='hierarchical')
    parser.add_argument('-neighbour_num', default=2, type=int, help='neighbour_num')
    ...
    parser.add_argument('-cf','--checkpoint-frequency', default=50, type=int, metavar='N',
